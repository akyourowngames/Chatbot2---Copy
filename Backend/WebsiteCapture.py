...
class WebsiteCapture:
    ...
    def url_to_pdf(self, url: str, include_images: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            # Generate relative paths for serving
            pdf_relative = f"/data/Captures/{pdf_filename}"
            thumbnail_relative = f"/data/Captures/thumbnails/{safe_name}_thumb.png" if thumbnail_path else None
